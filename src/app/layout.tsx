...
export const metadata: Metadata = {
  title: "Joule Ventures | Israeli Founders, U.S. Growth",
  description: "High-conviction venture capital backing Israeli founders commercializing enterprise solutions in U.S. markets. Day-one partners for exponential growth.",
  keywords: "venture capital, Israeli startups, enterprise software, deep tech, startup funding",
  metadataBase: new URL("https://jouleventures.com"),
  alternates: {
    canonical: "https://jouleventures.com"
  },
  openGraph: {
    title: "Joule Ventures | Israeli Founders, U.S. Growth",
    description: "High-conviction venture capital backing Israeli founders commercializing enterprise solutions",
    type: "website",
    siteName: "Joule Ventures"
  },
  twitter: {
    card: "summary_large_image",
    title: "Joule Ventures | Israeli Founders, U.S. Growth",
    description: "High-conviction venture capital backing Israeli founders"
  },
  robots: {
    index: true,
    follow: true
